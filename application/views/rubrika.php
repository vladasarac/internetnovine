...
<?php
// echo 'Prikazi sve tekstove iz rubrike: '.$rubrika;
...
<!--fajl prikazuje tekstove jedne rubrike, sa paginacijom-->
...
<div class="container naslovnaouter">
  ...
  <div class="col-xs-8 rubrika<?php echo strtolower($rubrika); ?>rubrika">
    <h1><?php echo $rubrika; ?></h1>
  </div>
